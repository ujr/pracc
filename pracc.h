...
#define VERSION "1.2.2" // burned into executable files
...
/* Directories */
#define PRACCDIR "/var/print/pracc" // where pracc files are stored
#define PRACCBIN "/var/print/bin" // where to install pracc tools
#define PRACCDOC "/var/print/doc" // must be accessible to pracc.cgi
#define PRACCCGI "/var/print/cgi" // where to put the CGI pracc.cgi

/* Used only in pracc.cgi */
#define PRACCPEEK "pracc-watch" // pracc observer group (read-only)
#define PRACCPOKE "pracc-admin" // pracc admin group (make changes)
